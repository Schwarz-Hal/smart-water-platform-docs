---
id: operator.anomaly-evaluation
title: 异常检测评测
...
related_operators: [anomaly_evaluation]
related_apis: []
...
算子 `anomaly_evaluation@1.0.0` 无需模型训练。输入prediction标准异常JSON与actual二元真实标签时序，计算Precision、Recall、F1及混淆矩阵。
